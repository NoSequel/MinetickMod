...
public class TileEntityHopper extends TileEntity implements IHopper {
        ...
        if (iinventory == null) {
            ...
            for (int i = 0; i < this.getSize(); ++i) {
                if (this.getItem(i) != null) {
                    ...
                    int facing = Facing.OPPOSITE_FACING[BlockHopper.b(this.p())];
    ...
    private static boolean canMergeItems(ItemStack itemstack, ItemStack itemstack1) {
        ...
        return itemstack.getItem() != itemstack1.getItem() ? false : (itemstack.getData() != itemstack1.getData() ? false : (itemstack.count >= itemstack.getMaxStackSize() ? false : ItemStack.equals(itemstack, itemstack1))); // Poweruser - stacks cant merge when count >= maxStackSize
    }
