...
public class BlockFalling extends Block {
    ...
    // Poweruser start
    private static Set<String> instantFall = Collections.synchronizedSet(new HashSet<String>());

    public static void enableInstantFall(World world) {
        instantFall.add(world.getWorld().getName());
    }

    public static void disableInstantFall(World world) {
        instantFall.remove(world.getWorld().getName());
    }

    public static boolean isInstantFallEnabled(World world) {
        return instantFall.contains(world.getWorld().getName());
    }
    // Poweruser end
