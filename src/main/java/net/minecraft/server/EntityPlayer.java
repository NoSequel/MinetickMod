...
public class EntityPlayer extends EntityHuman implements ICrafting {
    ...
    public void setViewDistance(int distance) {
        ...
        this.clientViewDistance = Math.min(this.clientViewDistance, ((WorldServer)world).getPlayerChunkMap().getViewDistance());
    ...
    public void openContainer(IInventory iinventory) {
        ...
        if (container == null) {
            iinventory.g(); // Should be closeContainer
            return;
        }
        // CraftBukkit end
    ...
    public void openHopper(TileEntityHopper tileentityhopper) {
        ...
        if (container == null) {
            tileentityhopper.g(); // Should be closeContainer
            return;
        }
        // CraftBukkit end
    ...
    public void openMinecartHopper(EntityMinecartHopper entityminecarthopper) {
        ...
        if (container == null) {
            entityminecarthopper.g(); // Should be closeContainer
            return;
        }
        // CraftBukkit end
    ...
    public void openFurnace(TileEntityFurnace tileentityfurnace) {
        ...
        if (container == null) {
            tileentityfurnace.g(); // Should be closeContainer
            return;
        }
        // CraftBukkit end
    ...
    public void openDispenser(TileEntityDispenser tileentitydispenser) {
        ...
        if (container == null) {
            tileentitydispenser.g(); // Should be closeContainer
            return;
        }
        // CraftBukkit end
    ...
    public void openBrewingStand(TileEntityBrewingStand tileentitybrewingstand) {
        ...
        if (container == null) {
            tileentitybrewingstand.g(); // Should be closeContainer
            return;
        }
        // CraftBukkit end
    ...
    public void openBeacon(TileEntityBeacon tileentitybeacon) {
        ...
        if (container == null) {
            tileentitybeacon.g(); // Should be closeContainer
            return;
        }
        // CraftBukkit end
